...
HD_PWD='C:/Users/dasan/Desktop/ECE385FinalProject/ece_385_final_vivado/ece_385_final_vivado.runs/LVL_1_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LVL_1_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LVL_1_rom.tcl
