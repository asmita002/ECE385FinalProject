...
#
# Generated by export_simulation on Sat Apr 20 18:24:56 -0500 2024
#
################################################################################
...
'-reset_run' switch to the './LVL_1_rom.sh' script.

./LVL_1_rom.sh -reset_run
...
./LVL_1_rom.sh -noclean_files

For more information on the script, please type './LVL_1_rom.sh -help'.
